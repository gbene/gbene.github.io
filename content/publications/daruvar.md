...
tags = ["publication"]
description = "Integrating structural and hydrogeological approaches to investigate fractured aquifers"
showdate = true
showtags = false
openaccess=true
pub=true
firstauthor=false
contributingauthor=true
...
Kosović, I., Matoš, B., Casiraghi, S., Benedetti, G., Frangen, T., Urumović, K., ... & Borović, S. (2024). Hydrogeological parameterisation of the Daruvar thermal aquifer: integration of fracture network analysis and well testing. Geologia Croatica, 77(2), 99-125.
